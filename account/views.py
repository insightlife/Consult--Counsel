...
def signup(request):
    if request.method == "POST":
        ...
        v = account.objects.create(Name = username, Email = email,
            Mobile = mobile, Role = role, Institute = Schoolcollege, Typeofinst=inst,  Linkedin = linkedin, Aboutclient = Abouturself)
        v.save()
        if fm.is_valid():
            fm.save()

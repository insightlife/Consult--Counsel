...
urlpatterns = [
    ...
    path('Jangyaseni',views.Jangyaseni),
    path('ankita',views.ankita),
    path('monalisha',views.monalisha),
    path('manoranjan',views.manoranjan),
    path('pratyasha',views.pratyasha),
    path('hasita',views.hasita),
    path('keerti',views.keerti),
    path('rajlaxmi',views.rajlaxmi),
    path('subhasmita',views.subhasmita),
    path('shivam',views.shivam),
]
